...
replaceFile('src/pages/GatewayPage.tsx',
  /const title = app\.seo_title \|\| `\$\{app\.name\} - Secure Gateway`;\n  const desc = app\.seo_description \|\| `Authorized secure download mirror for \$\{app\.name\}\.`;/,
...
if (fs.existsSync(adminFile)) {
  ...
  content = content.replace(/<div>\s*<label[^>]*>\s*SEO Optimized Title<\/label>\s*<input[^>]*value={item\.seo_title}[^>]*>\s*<\/div>/sg, '');
  content = content.replace(/<div>\s*<label[^>]*>\s*SEO Meta Description<\/label>\s*<textarea[^>]*value={item\.seo_description}[^>]*><\/textarea>\s*<\/div>/sg, '');
  
  // Remove SEO Blog Block
  content = content.replace(/<div>\s*<label[^>]*>\s*SEO Title<\/label>\s*<input[^>]*value={blog\.seo_title(?: \|\| '')?}[^>]*>\s*<\/div>/sg, '');
  content = content.replace(/<div>\s*<label[^>]*>\s*SEO Description<\/label>\s*<textarea[^>]*value={blog\.seo_description(?: \|\| '')?}[^>]*><\/textarea>\s*<\/div>/sg, '');
  
  // Remove SEO Videos Block
  content = content.replace(/<div>\s*<label[^>]*>\s*SEO Optimized Header<\/label>\s*<input[^>]*value={item\.seo_title}[^>]*>\s*<\/div>/sg, '');
  content = content.replace(/<div>\s*<label[^>]*>\s*SEO Meta String<\/label>\s*<textarea[^>]*value={item\.seo_description}[^>]*><\/textarea>\s*<\/div>/sg, '');
