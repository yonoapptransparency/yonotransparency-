...
export default function AppDetails() {
  ...
  return (
    <div className="animate-fade-in max-w-[1550px] mx-auto select-none">
      ...
      <div className="mt-8 mb-12 mx-4 w-auto animate-fade-in relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-900 to-zinc-800 dark:from-zinc-800 dark:to-zinc-900 shadow-xl border border-white/10 p-1">
        <div className="absolute inset-0 bg-blue-500/5 mix-blend-overlay"></div>
        <div className="relative bg-zinc-900/40 dark:bg-black/20 backdrop-blur-md rounded-[28px] p-8 flex flex-col md:flex-row items-center justify-between gap-6 z-10 border border-white/5">
          <div className="flex-1 text-center md:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-500/20 border border-blue-500/30 text-blue-400 text-xs font-bold uppercase tracking-widest mb-3">
              <ShieldCheck className="w-4 h-4" />
              <span>Verified Secure</span>
            </div>
            <h2 className="text-xl sm:text-2xl font-extrabold text-white mb-2 tracking-tight">
              Ready to Securely Access {app.name}?
            </h2>
            <p className="text-zinc-400 text-sm font-medium max-w-xl mx-auto md:mx-0 leading-relaxed">
              Experience the encrypted verification gateway for a robust and private download experience.
            </p>
          </div>
          ...
          <div className="shrink-0 w-full md:w-auto">
            <button 
              onClick={handleMoreDetails}
              className="w-full sm:w-auto px-8 py-4 bg-blue-600 hover:bg-blue-500 text-white rounded-2xl font-bold transition-all shadow-lg shadow-blue-900/20 active:scale-95 flex items-center justify-center gap-2"
            >
